        ...
        <div class="login-panel">
            <div class="row">
                <div class="form-section">
                    ...
                    <h2 class="welcoming">Daftarkan data diri anda.</h2>
                    <form action="{{ route('register') }}" method="POST">
                        ...
                        <div class="input-group">
                            <div class="input-wrapper">
                                ...
                                <input class="input" type="text" name="name" id="nama" placeholder="Muhamad" autofocus>
                            </div>
                            <div class="input-wrapper bt-0">
                                <div class="on-focus"></div>
                                <label for="email">Alamat Email</label>
                                <input class="input" type="email" name="email" id="email" placeholder="muhamad@gmail.com">
                            </div>
                            <div class="input-wrapper bt-0">
                                <div class="on-focus"></div>
                            ...
                            <div class="input-wrapper bt-0">
                                <div class="on-focus"></div>
                                <label for="password">Password</label>
                                <input class="input" type="password" name="password_confirmation" id="password" placeholder="********">
                            </div>
                            
                        </div>
                        <div class="row between mt-5">
                            <a href="/login" class="button btn-masuk">Masuk</a>
                            <button type="submit" class="button btn-daftar">Daftar</button>
                        </div>
                    </form>
                </div>
