...
class Forum {
  ...
  autocompleteInput = tagCompletition => {
    if (typeof tagCompletition !== 'object') {
        ...
        .autocomplete({
          ...
          source: function (request, response) {
            ...
            response($.ui.autocomplete.filter(
              tagCompletition, extractLast(request.term)));
          },
          focus: function () {
  ...
  createTextEditor = () => {
    ...
    var dafont = Quill.import('formats/font')
    dafont.whitelist = ['Lato']
    Quill.register(dafont, true)
  ...
  storeForm = () => {
    document.querySelector('.btn-post').addEventListener('click', e => {
      e.preventDefault()
      this.quillContents = this.quill.getContents().ops
      document.getElementById('title').value = this.quillContents[0].insert
      document.getElementById('content').value = JSON.stringify(this.quillContents)
...
},{"axios":6,"quill":32}],6:[function(require,module,exports){
...
},{"./adapters/http":7,"./adapters/xhr":7,"./helpers/normalizeHeaderName":27,"./utils":30,"_process":4}],21:[function(require,module,exports){
'use strict';
